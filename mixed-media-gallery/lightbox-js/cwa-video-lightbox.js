function videoLightbox(arrVideos, selectedIndex) {
    ...
    function showLightbox(index) {
        ...
        let videoContainer = $(`
            <video controls disablepictureinpicture autoplay loop>
        ...
        newVideo.onloadedmetadata = function() {
            ...
            // Ahora aseguramos que el video se reproduce automáticamente
            videoContainer.get(0).play(); // Reproducir el video
            videoContainer.get(0).loop = true; 
